...
<head>
    ...
    <style>
        ...
        background-color: <?php echo C('cfg_bg') ;?>
...
<div class="container">
    <form class="form-signin" method="post" action="#" novalidate="novalidate">
        ...
        <div class="login-wrap">
            ...
            <input type="button" class="btn btn-lg btn-login btn-block" id="btn" value="登录">
            <input type="button" class="btn btn-lg btn-login btn-block" id="btn_register" value="注册">
        </div>
    </form>
</div>
...
<script>
    ...
    $("#btn_register").click(function () {
        var url = "<?php echo C('cfg_app'); ?>/Home/Index/register";
