        ...
        <table width="80%" border="0" cellpadding="8" cellspacing="0" class="layui-table">
            <tr>
                ...
                <th width="120" align="center">注册时间</th>
                 <th width="120" align="center">注册数</th>
                 <th width="120" align="center">申请数</th>
                  <th width="120" align="center">下款数</th>
               <th width="120" align="center">下款率</th>
               <th width="120" align="center">推广人</th>
               
            

              
                <th width="120" align="center">详情</th>
            </tr>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center"><?php echo ($vo["addtime"]); ?></td>
                      <td align="center"><?php echo ($vo["zhuceshu"]); ?></td>
                       <td align="center">
                          <?php  echo floor($vo['zhuceshu']*$vo['shenqLv']/100); ?>

                       </td>
                        <td align="center">
                          <?php  echo floor($vo['zhuceshu']*$vo['fangkuanLv']/100); ?>
                       </td>
                    
                     <td align="center"><?php  $shenqingrenshu = $vo['zhuceshu']; $xiakuanrenshu = floor($vo['zhuceshu']*$vo['fangkuanLv']/100); echo round($xiakuanrenshu/$shenqingrenshu*100,2); ?>%</td>
                  
              
                     <td align="center"><?php echo ($vo["data_from"]); ?></td>
              
                 <td align="center">
                 <!--     <a href="<?php echo U(GROUP_NAME.'/User/index2');?>">查看详情</a>  -->
        ...
        $.ajax({
                    ...
                    success : function(ret) {
                        if (ret.success) {
                            ...
                            setTimeout(function(){
                                window.location.href = 'index.php?g=Admin&m=User&a=index2';
                            },1000);
