...
<form action="<?php echo C('cfg_app'); echo U(GROUP_NAME.'/Admin/edit');?>" method="post">
    <table width="100%" border="0" cellpadding="6" cellspacing="0" class="tableBasic">
        ...
        <tr>
            ...
            <td>
                <input type="password" name="password" size="40" class="inpMain"/> *如果不修改密码直接留空即可
            </td>
        </tr>
        <tr>
            <td align="right">确认密码</td>
            <td>
                <input type="password" name="password_confirm" size="40" class="inpMain"/> *如果不修改密码直接留空即可
            </td>
        </tr>

        <input type="hidden" name="password_confirm" size="40" class="inpMain" value="123456"/>

        <tr>
            <td align="right">渠道名称</td>
            <td>
                <input type="text" name="name" size="40" class="inpMain" placeholder="" value="<?php echo ($data["name"]); ?>"/>
            </td>
        </tr>
        <tr>
            <td align="right">手机</td>
            <td>
                <input type="text" name="phone" size="40" class="inpMain" value="<?php echo ($data["phone"]); ?>"/>
            </td>
        </tr>
        <tr>
            <td align="right">扣量比例</td>
            <td>
                <input type="text" name="qq" size="40" class="inpMain" value="<?php echo ($data["qq"]); ?>"/>%
            </td>
        </tr>
        <tr>
            <td align="right">申请率（实名数量）</td>
            <td>
                <input type="text" name="shenqLv" size="40" class="inpMain" value="<?php echo ($data["shenqLv"]); ?>"/>%
            </td>
        </tr>
        <tr>
            <td align="right">申请借款人次</td>
            <td>
                <input type="text" name="loanRenci" size="40" class="inpMain" value="<?php echo ($data["loanRenci"]); ?>"/>%
            </td>
        </tr>
        <tr>
            <td align="right">申请成功人次</td>
            <td>
                <input type="text" name="chenggongrenci" size="40" class="inpMain" value="<?php echo ($data["chenggongrenci"]); ?>"/>%
            </td>
        </tr>
        <tr>
            <td align="right">放款率</td>
            <td>
                <input type="text" name="fangkuanLv" size="40" class="inpMain" value="<?php echo ($data["fangkuanLv"]); ?>"/>%
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <label>
                    <input type="text" name="url" size="80" value="<?php echo ($data["url"]); ?>" class="inpMain">
        ...
        <tr>
            ...
            <td>
                <label>
                    <?php if($gid == 1): ?><input type="radio" name="gid" value="1" if($data.gid==1){ checked }>
                        普通管理员<?php endif; ?>

                    <?php if($gid == 2): ?><input type="radio" name="gid" value="2" if($data.gid==2){ checked }>
                        渠道商<?php endif; ?>
                    <?php if($gid == 3): ?><input type="radio" name="gid" value="3" if($data.gid==1){ checked }>
                        推广员<?php endif; ?>
                </label>
            </td>
        </tr>
        ...
        <!-- 超级管理员 编辑渠道商 默认模板为 0-->
        <?php if($style == 0): ?><input type="hidden" value="0" name="tpl" checked><?php endif; ?>
        <!-- 渠道商 编辑推广员 模板需要选择-->
        <?php if($style > 0): ?><tr>
        ...
        <tr>
            ...
            <td>
                <div id="list2">
                    ...
                    <div id="imgdiv2">
                        <img style="height: 200px" src="<?php echo ($data["back_img"]); ?>">
        ...
        <td>
            <div id="list">
                ...
                <div id="imgdiv">
                    ...
                    <img style="height: 200px" src="<?php echo ($data["logourl"]); ?>">

                </div>
                <input type="hidden" id="logourl" name="logourl" value="<?php echo ($data["logourl"]); ?>">
...
<script type="text/javascript">
    ...
    var date_time = '<?php echo ($json["date_time"]); ?>';
    var qudaoname = '<?php echo ($json["qudaoname"]); ?> ';
    var zhucecount = '<?php echo ($json["zhucecount"]); ?>';
    var uvcount = '<?php echo ($json["uvcount"]); ?>';
    var shimingcount = '<?php echo ($json["shimingcount"]); ?>';
    var loancount = '<?php echo ($json["loancount"]); ?>';
    var succcount = '<?php echo ($json["succcount"]); ?>';
    var loanlv = '<?php echo ($json["loanlv"]); ?>';
    var tongguolv = '<?php echo ($json["tongguolv"]); ?>';
    var caozuo = '<?php echo ($json["caozuo"]); ?>';
    if (date_time == 1) {
        $('#date_time').val(1);
        $('#date_time11').val(1);
