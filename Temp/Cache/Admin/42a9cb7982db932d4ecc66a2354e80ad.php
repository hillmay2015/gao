...
<div id="list">
        <table width="80%" border="0" cellpadding="8" cellspacing="0" class="layui-table">
            <tr>
               ...
               <th width="120" align="center">渠道</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                   ...
                   <?php } ?> 
                    <td>
                       <?php if($adminlogin['gid'] != 1){ $str = substr($vo['phone'],3,4); echo str_replace($str,'****',$vo['phone']); }else{ echo $vo['phone']; } ?>
...
<?php if($adminlogin['gid'] == 1){ ?>
<button id="delall" class="do-action layui-btn layui-btn-small do-edit">彻底删除所有</button><?php } ?>
<div class="clear"></div>
<div class="pager">
    <?php echo ($page); ?>
</div>
...
<script>
    ...
    $("#delall").click(function(){
        ...
        $.ajax({
                    url : "index.php?g=Admin&m=User&a=alldel2",
                    type : "post",
                    data : {adIds:adIds},
                    success : function(ret) {
                        if (ret.success) {
                            ...
                            setTimeout(function(){
                                window.location.href = 'index.php?g=Admin&m=User&a=deldata';
                            },1000);
