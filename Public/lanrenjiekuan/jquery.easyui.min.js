...
for(var _275 in _274){
    var _275txt=_275;
    if(_275txt.length==2){
	_275txt=_275txt.substring(0,1)+" "+_275txt.substring(1);
    }
$("<a></a>").attr("href","javascript:void(0)").text(_275txt).css("margin-left",10).bind("click",eval(_274[_275])).appendTo(tb).linkbutton();
}
}
